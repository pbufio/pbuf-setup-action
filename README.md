...
## Inputs
- **`version`**: The version of the CLI to install. The default is 'v0.5.0'. This input is optional.
...
- name: Install pbuf-cli
  ...
  with:
    version: 'v0.5.0' # Optional. Specify the desired version
    pbuf_token: ${{ secrets.PBUF_TOKEN }} # Optional, your PBUF API token

- name: Register Module
  id: pbuf-register
  run: pbuf modules register
